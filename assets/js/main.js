...
const sendEmail = (e) => {
  ...
  if(contactName.value === '' || contactEmail.value === '' || contactProject.value === ''){
    ...
    emailjs.sendForm('service_grg0f84', 'template_p9it2xe', '#contact-form', 'qa7P2vfKAugsy8cRv')
      .then(() =>{
      //show Message add color
      contactMessage.classList.add('color-blue')
      contactMessage.textContent = 'Message sent ❤️'

      //Remove message sent after 5s
      setTimeout(() => {
        contactMessage.textContent = ''
      }, 5000)
    }, (error) => {
      alert('OOps! Someyhing went wrong', error)
    })
...
sr.reveal('.home__info div', {delay:600, origin: 'bottom', intervel: 100})
